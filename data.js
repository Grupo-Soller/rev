...
values2: [
    ...
    leadSource: {
        distribution: {
            inbound: { percentage: 60, count: 1926 },
            outbound: { percentage: 40, count: 1306 }
        },
        byCoordinator: {
  ...
  top5: [
    ...
    techStack: {
        current: [
            { name: 'Excel', status: 'transition', adoption: 100, category: 'Analytics' },
            ...
            { name: 'Oitchau', status: 'active', adoption: 100, category: 'Communication', risk: '' },
        ]
    },
